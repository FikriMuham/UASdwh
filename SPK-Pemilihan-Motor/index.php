...
<head>
	...
	<meta property="og:image" content="assets/image/motor.jpg" />
    ...
    <!-- Body Start -->
		...
		<div id="index-banner" class="parallax-container">
			<div class="section no-pad-bot">
				<div class="container">
					<h1 class="header jarak center white-text" style="font-size: 40px">SISTEM PENDUKUNG KEPUTUSAN PEMILIHAN MOTOR</h1>
			...
			<div class="parallax"><img src="assets/image/motor.jpg" alt="Laptop"></div>
		</div>
		<!-- Jumbotron End -->
		    ...
		    <div class="section-card" style="padding: 36px 0px">
		    	<div class="row">
		    		<div class="col s6">
			    		...
			    		<p style="text-align: justify; padding-right: 16px;">Sistem Pendukung Keputusan Pemilihan Motor ini menggunakan metode TOPSIS yang dibangun menggunakan bahasa PHP. Sistem ini dibuat sebagai Tugas Akhir Mata Kuliah Sistem Pendukung Keputusan Prodi Teknik Informatika PoliTeknik Harapan Bersama Tegal. </p>
						</div>
			    	<div class="col s6">

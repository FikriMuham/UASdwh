	...
	<div style="background-color: #efefef">
		<div class="container">
			<div class="section-card" style="padding: 20px 0px">
				...
				<center>
					<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #635c73;">HASIL REKOMENDASI MOTOR</h4>
				</center>
				<ul>
					<li>
						<div class="row">
							<div class="card">
								<div class="card-content">
									<h5 style="margin-bottom: 16px; margin-top: -6px;">Matrik Motor</h5>
									<table class="responsive-table">
										...
										<tbody>
											...
											$no=1;
											while ($data_motor=mysqli_fetch_array($query)) {
												$Matrik[$no-1]=array($data_motor['harga_angka'],$data_motor['merek_angka'],$data_motor['ukuran_angka'],$data_motor['model_angka'],$data_motor['garansi_angka'] );
												?>
												<tr>
													<td><center><?php echo "A",$no ?></center></td>
													<td><center><?php echo $data_motor['harga_angka'] ?></center></td>
													<td><center><?php echo $data_motor['merek_angka'] ?></center></td>
													<td><center><?php echo $data_motor['ukuran_angka'] ?></center></td>
													<td><center><?php echo $data_motor['model_angka'] ?></center></td>
													<td><center><?php echo $data_motor['garansi_angka'] ?></center></td>
												</tr>
												<?php
												$no++;
											}
									...
									<table class="responsive-table">
										...
										<tbody>
											...
											while ($data_motor=mysqli_fetch_array($query)) {
												...
												$MatrikNormalisasi[$no-1]=array($data_motor['harga_angka']/$pembagiNM[0],
													$data_motor['merek_angka']/$pembagiNM[1],
													$data_motor['ukuran_angka']/$pembagiNM[2],
													$data_motor['model_angka']/$pembagiNM[3],
													$data_motor['garansi_angka']/$pembagiNM[4]);

													?>
													<tr>
														<td><center><?php echo "A",$no ?></center></td>
														<td><center><?php echo round($data_motor['harga_angka']/$pembagiNM[0],6)?></center></td>
														<td><center><?php echo round($data_motor['merek_angka']/$pembagiNM[1],6) ?></center></td>
														<td><center><?php echo round($data_motor['ukuran_angka']/$pembagiNM[2],6) ?></center></td>
														<td><center><?php echo round($data_motor['model_angka']/$pembagiNM[3],6) ?></center></td>
														<td><center><?php echo round($data_motor['garansi_angka']/$pembagiNM[4],6) ?></center></td>
													</tr>
													<?php
													$no++;
												}
										...
										<table class="responsive-table">
											<thead>
												<tr>
													...
													<th><center>Value Kriteria Merek</center></th>
													<th><center>Value Kriteria Ukuran</center></th>
													<th><center>Value Kriteria Model</center></th>
													<th><center>Value Kriteria Garansi</center></th>
												</tr>
											</thead>
											<tbody>
												<!--count($W)-->
											...
											<table class="responsive-table" >
												...
												<thead style="border-top: 1px solid #d0d0d0;">
													<tr>
														...
														<th></th>
														<th><center>Alternatif Motor terpilih</center></th>
													</tr>
												</thead>
												<tbody>
													<tr>
														...
														for ($i=0; $i < count($nilaiV); $i++) { 
															if ($nilaiV[$i] == $testmax) {
																$query=mysqli_query($selectdb,"SELECT * FROM data_motor where id_motor = $i+1");
																?>
																<td><center><?php echo "V".($i+1); ?></center></td>
																<td><center><?php echo $nilaiV[$i]; ?></center></td>
																<?php while ($user=mysqli_fetch_array($query)) { ?>
																<td><center><?php echo $user['nama_motor']; ?></center></td>
																<?php
															}
														}
													} ?>
